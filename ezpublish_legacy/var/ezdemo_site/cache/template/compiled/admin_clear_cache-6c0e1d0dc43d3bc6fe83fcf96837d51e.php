<?php
// URI:       design/admin/templates/toolbar/full/admin_clear_cache.tpl
// Filename:  design/admin/templates/toolbar/full/admin_clear_cache.tpl
// Timestamp: 1385723972 (Fri Nov 29 12:19:32 CET 2013)
$oldSetArray_2ac6b63ffe1fe1b5d15b5c656f2f26f2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '	       <h4><span class="disabled">Clear cache</span></h4>
	    ';
}
else
{
...
<div class="box-bc"><div class="box-ml"><div class="box-content">
    ...
    ';
$oldRestoreIncludeArray_cf19e6ea343dcbadd2660f26aa19d536 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/clear_cache-cb6452253326b857ac266807d6613824.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/clear_cache-cb6452253326b857ac266807d6613824.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_cf19e6ea343dcbadd2660f26aa19d536;
...
$setArray = $oldSetArray_2ac6b63ffe1fe1b5d15b5c656f2f26f2;
$tpl->Level--;
?>
