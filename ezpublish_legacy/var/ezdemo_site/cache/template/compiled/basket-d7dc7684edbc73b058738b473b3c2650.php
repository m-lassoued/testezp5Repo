<?php
// URI:       design:shop/basket.tpl
// Filename:  extension/ezdemo/design/ezdemo/templates/shop/basket.tpl
// Timestamp: 1389968166 (Fri Jan 17 15:16:06 CET 2014)
$oldSetArray_f2efe1c53877c7dc4cff10d19f70888a = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form method="post" action="/testezp/web/index.php/eng/shop/basket">

<div class="attribute-header">
    <h1 class="long">Basket</h1>
</div>';
unset( $show );
unset( $show );
$show = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'removed_items', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['removed_items'] : null;
...
$var = strtr( 'The following items were removed from your basket because the products were changed.', $var3 );
...
unset( $loopItem );
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'removed_items', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['removed_items'] : null;
...
$currentNamespace .= ( $currentNamespace ? ":" : "" ) . 'RemovedItem';
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'vat_is_known', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['vat_is_known'] : null;
...
<h2>VAT is unknown</h2>
VAT percentage is not yet known for some of the items being purchased.<br/>
This probably means that some information about you is not yet available and will be obtained during checkout.
</div>';
}
unset( $if_cond );
// if ends
...
unset( $show );
unset( $show );
$show = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'error', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['error'] : null;
if (! isset( $show ) ) $show = NULL;
while ( is_object( $show ) and method_exists( $show, 'templateValue' ) )
    $show = $show->templateValue();
...
unset( $show1 );
unset( $show1 );
$show1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'error', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['error'] : null;
...
$var = strtr( 'Attempted to add object without price to basket.', $var3 );
unset( $var2, $var3, $var4, $var5 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$var = strtr( 'Your payment was aborted.', $var3 );
unset( $var2, $var3, $var4, $var5 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'basket', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['basket'] : null;
...
if ( $tpl->hasVariable( 'currency', $rootNamespace ) )
{
  ...
  2 => 'extension/ezdemo/design/ezdemo/templates/shop/basket.tpl',
) );
...
unset( $show );
unset( $show );
$show = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'basket', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['basket'] : null;
$show1 = compiledFetchAttribute( $show, 'items' );
unset( $show );
$show = $show1;
if (! isset( $show ) ) $show = NULL;
while ( is_object( $show ) and method_exists( $show, 'templateValue' ) )
...
$namespaceStack[] = $currentNamespace;
$currentNamespace .= ( $currentNamespace ? ":" : "" ) . 'Basket';
...
unset( $loopItem );
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'basket', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['basket'] : null;
$loopItem1 = compiledFetchAttribute( $loopItem, 'items' );
unset( $loopItem );
$loopItem = $loopItem1;
if (! isset( $loopItem ) ) $loopItem = NULL;
while ( is_object( $loopItem ) and method_exists( $loopItem, 'templateValue' ) )
...
$text .= '<tr class="bglight">
    <td colspan="7"><input type="hidden" name="ProductItemIDList[]" value="';
unset( $var );
$namespace = $rootNamespace;
if ( $namespace == '' )
    $namespace = "Basket:ProductItem";
else
    $namespace .= ':Basket:ProductItem';
unset( $var );
...
<tr class="bgdark">
    <td>
    <input type="text" name="ProductItemCountList[]" value="';
unset( $var );
$namespace = $rootNamespace;
if ( $namespace == '' )
    $namespace = "Basket:ProductItem";
...
$if_cond2 = compiledFetchAttribute( $if_cond1, 'vat_value' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
...
$text .= '
    ...
    <td>
    <input type="checkbox" name="RemoveProductItemDeleteList[]" value="';
unset( $var );
$namespace = $rootNamespace;
if ( $namespace == '' )
    $namespace = "Basket:ProductItem";
...
<tr class="bglight">
    <td colspan="6"><input class="button" type="submit" name="StoreChangesButton" value="Update" /></td>
    <td colspan="1"><input class="button" type="submit" name="RemoveProductItemButton" value="Remove" /> </td>
</tr>';
unset( $show );
$namespace = $rootNamespace;
if ( $namespace == '' )
...
$namespace = $rootNamespace;
if ( $namespace == '' )
    $namespace = "Basket:ProductItem:Options";
else
    $namespace .= ':Basket:ProductItem:Options';
unset( $var );
$var = ( array_key_exists( $namespace, $vars ) and array_key_exists( 'item', $vars[$namespace] ) ) ? $vars[$namespace]['item'] : null;
...
<tr>
     ...
     <td>
     <strong>Subtotal inc. VAT</strong>:
     </td>
</tr>
<tr>
    <td colspan="5">
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'shipping_info', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['shipping_info'] : null;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'shipping_info', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['shipping_info'] : null;
$var2 = compiledFetchAttribute( $var1, 'management_link' );
unset( $var1 );
$var1 = $var2;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $if_cond );
unset( $if_cond );
$if_cond = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'shipping_info', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['shipping_info'] : null;
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'shipping_info', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['shipping_info'] : null;
...
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'shipping_info', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['shipping_info'] : null;
$var2 = compiledFetchAttribute( $var1, 'cost' );
unset( $var1 );
$var1 = $var2;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'total_inc_shipping_ex_vat', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['total_inc_shipping_ex_vat'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'total_inc_shipping_inc_vat', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['total_inc_shipping_inc_vat'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
$setArray = $oldSetArray_f2efe1c53877c7dc4cff10d19f70888a;
$tpl->Level--;
?>
