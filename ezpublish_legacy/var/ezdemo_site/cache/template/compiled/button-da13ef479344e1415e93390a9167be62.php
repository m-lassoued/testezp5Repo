<?php
// URI:       design/standard/templates/gui/button.tpl
// Filename:  design/standard/templates/gui/button.tpl
// Timestamp: 1385723972 (Fri Nov 29 12:19:32 CET 2013)
$oldSetArray_a5f84b1e57534f7cd1aa481ef3da14c2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'disabled', $rootNamespace ) )
{
  ...
  2 => 'design/standard/templates/gui/button.tpl',
) );
...
if ( $if_cond )
{
$text .= '<input class="button-disabled" disabled="disabled" type="submit" name="';
unset( $var );
unset( $var );
...
$setArray = $oldSetArray_a5f84b1e57534f7cd1aa481ef3da14c2;
$tpl->Level--;
?>
