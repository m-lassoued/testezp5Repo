...
$oldSetArray_f0975c661bfcef627e54facab9488d30 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="clearcacheform" method="post" action="/testezp/web/index.php/ezdemo_site_admin/setup/cache">
...
<tr>
    <th class="tight"><img src="/testezp/web/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." onclick="ezjs_toggleCheckboxes( document.clearcacheform, \'CacheList[]\' ); return false;" title="Invert selection." /></th>
    <th>Name</th>
    <th>Path</th>
</tr>';
unset( $loopItem );
...
$setArray = $oldSetArray_f0975c661bfcef627e54facab9488d30;
$tpl->Level--;
?>
