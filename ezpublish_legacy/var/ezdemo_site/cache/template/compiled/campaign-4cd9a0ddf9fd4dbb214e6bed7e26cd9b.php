...
$oldSetArray_cbc2632c4d2080e51ee713e5a6c063ef = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
// foreach begins
$skipDelimiter = true;
if ( !isset( $fe_variable_stack_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) ) $fe_variable_stack_7bbb3fe0db154c0fe51f5bd48db44db3_1 = array();
$fe_variable_stack_7bbb3fe0db154c0fe51f5bd48db44db3_1[] = compact( 'fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_array_keys_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_n_items_processed_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_key_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_val_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_reverse_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_first_val_7bbb3fe0db154c0fe51f5bd48db44db3_1', 'fe_last_val_7bbb3fe0db154c0fe51f5bd48db44db3_1' );
unset( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 );
unset( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 );
$fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'valid_nodes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['valid_nodes'] : null;
if (! isset( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) ) $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 = NULL;
while ( is_object( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) and method_exists( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1, 'templateValue' ) )
    $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1->templateValue();

$fe_array_keys_7bbb3fe0db154c0fe51f5bd48db44db3_1 = is_array( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) ? array_keys( $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) : array();
$fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 = count( $fe_array_keys_7bbb3fe0db154c0fe51f5bd48db44db3_1 );
$fe_n_items_processed_7bbb3fe0db154c0fe51f5bd48db44db3_1 = 0;
$fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 = 0;
$fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 - $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1;
$fe_reverse_7bbb3fe0db154c0fe51f5bd48db44db3_1 = false;
if ( $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 < 0 || $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 >= $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 )
{
    $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 = ( $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 < 0 ) ? 0 : $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1;
    if ( $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 || $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 < 0 )
 {
        eZDebug::writeWarning("Invalid 'offset' parameter specified: '$fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1'. Array count: $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1");   
}
}
if ( $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 < 0 || $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 + $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 > $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 )
{
    if ( $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 < 0 )
 eZDebug::writeWarning("Invalid 'max' parameter specified: $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1");
    $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 - $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1;
}
if ( $fe_reverse_7bbb3fe0db154c0fe51f5bd48db44db3_1 )
{
    $fe_first_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 - 1 - $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1;
    $fe_last_val_7bbb3fe0db154c0fe51f5bd48db44db3_1  = 0;
}
else
{
    $fe_first_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1;
    $fe_last_val_7bbb3fe0db154c0fe51f5bd48db44db3_1  = $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 - 1;
}
// foreach
for ( $fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_first_val_7bbb3fe0db154c0fe51f5bd48db44db3_1; $fe_n_items_processed_7bbb3fe0db154c0fe51f5bd48db44db3_1 < $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 && ( $fe_reverse_7bbb3fe0db154c0fe51f5bd48db44db3_1 ? $fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1 >= $fe_last_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 : $fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1 <= $fe_last_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 ); $fe_reverse_7bbb3fe0db154c0fe51f5bd48db44db3_1 ? $fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1-- : $fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1++ )
{
$fe_key_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_array_keys_7bbb3fe0db154c0fe51f5bd48db44db3_1[$fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1];
$fe_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 = $fe_array_7bbb3fe0db154c0fe51f5bd48db44db3_1[$fe_key_7bbb3fe0db154c0fe51f5bd48db44db3_1];
$vars[$rootNamespace]['img_node'] = $fe_val_7bbb3fe0db154c0fe51f5bd48db44db3_1;
$vars[$rootNamespace]['k'] = $fe_key_7bbb3fe0db154c0fe51f5bd48db44db3_1;
$text .= '<li>';
unset( $var );
unset( $var );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/article-2d2a0aad31bca22f33954bbffe85f3ae.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/article-2d2a0aad31bca22f33954bbffe85f3ae.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/image-eb0cf712da55e40dc5cd18afd84557f5.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/image-eb0cf712da55e40dc5cd18afd84557f5.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$text .= '</li>';
$fe_n_items_processed_7bbb3fe0db154c0fe51f5bd48db44db3_1++;
} // foreach
$skipDelimiter = false;
if ( count( $fe_variable_stack_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) ) extract( array_pop( $fe_variable_stack_7bbb3fe0db154c0fe51f5bd48db44db3_1 ) );
...
unset( $fe_array_keys_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_n_items_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_n_items_processed_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_i_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_key_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_offset_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_max_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_reverse_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_first_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_last_val_7bbb3fe0db154c0fe51f5bd48db44db3_1 );

unset( $fe_variable_stack_7bbb3fe0db154c0fe51f5bd48db44db3_1 );
...
$setArray = $oldSetArray_cbc2632c4d2080e51ee713e5a6c063ef;
$tpl->Level--;
?>
