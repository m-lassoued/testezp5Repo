...
$oldSetArray_cc2548c6afff913bf7810e5eb51849d9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="children" method="post" action="/testezp/web/index.php/ezdemo_site_admin/content/action">
...
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
$var = $var1 ? $var3 : '"/testezp/web/index.php/ezdemo_site_admin"';
unset( $var1, $var3 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$text .= ' title="Up one level."><img src="/testezp/web/design/admin/images/up-16x16-grey.png" width="16" height="16" alt="Up one level." title="Up one level." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$text .= '
    ...
    ';
$oldRestoreIncludeArray_a21f7453d9c5ab3dc9945b1204811327 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/children_detailed-828b775060305f3d307a5581a1f9dae6.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/children_detailed-828b775060305f3d307a5581a1f9dae6.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_a21f7453d9c5ab3dc9945b1204811327;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_dffb9bb1a8d4c4f39ca71c73e90a167c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/alphabetical-b19849f0b28eef6b5656e9ccc4585de7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/alphabetical-b19849f0b28eef6b5656e9ccc4585de7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_dffb9bb1a8d4c4f39ca71c73e90a167c;
...
$setArray = $oldSetArray_cc2548c6afff913bf7810e5eb51849d9;
$tpl->Level--;
?>
