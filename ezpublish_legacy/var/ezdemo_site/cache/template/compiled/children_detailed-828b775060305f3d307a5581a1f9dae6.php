...
$oldSetArray_04b5aea3b2ed1d4fb449c1a334f6c489 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '",
    editPrefixURL: "/testezp/web/index.php/ezdemo_site_admin/content/edit",
    rowsPrPage: ';
unset( $var );
unset( $var );
...
$setArray = $oldSetArray_04b5aea3b2ed1d4fb449c1a334f6c489;
$tpl->Level--;
?>
