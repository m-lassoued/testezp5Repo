...
$oldSetArray_a4766a50ed0117782e8d3d146cc7269f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form id="clearcache" action="/testezp/web/index.php/ezdemo_site_admin/setup/cachetoolbar" method="post">';
...
$setArray = $oldSetArray_a4766a50ed0117782e8d3d146cc7269f;
$tpl->Level--;
?>
