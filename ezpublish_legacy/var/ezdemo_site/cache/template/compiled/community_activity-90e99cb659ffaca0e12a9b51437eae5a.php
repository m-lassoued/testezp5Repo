...
$oldSetArray_7d0effc43eede800ddca4ccb95414f94 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '"><img width="16px" height="16px" src="/testezp/web/extension/ezdemo/design/ezdemo/images/rss-icon.gif" /></a></span>
...
$text .= '"><img width="16px" height="16px" src="/testezp/web/design/standard/images/twitter-icon.png" /></a></span>
...
$text .= '"><img width="16px" height="16px" src="/testezp/web/design/standard/images/googleplus-icon.png" /></a></span>
</div>
<div class="break"></div>
<div class="community-activity">
    <div class="loading">
        Loading the latest forum posts...
        <img src="/testezp/web/design/admin/images/2/loader.gif" />
    </div>
...
$setArray = $oldSetArray_7d0effc43eede800ddca4ccb95414f94;
$tpl->Level--;
?>
