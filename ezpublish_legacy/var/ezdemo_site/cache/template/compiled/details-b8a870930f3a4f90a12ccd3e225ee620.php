...
$oldSetArray_4eb65d7be99018faf77398beceddf860 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="statesform" method="post" action="/testezp/web/index.php/ezdemo_site_admin/state/assign">
...
unset( $var2 );
unset( $var3 );
$var3 = ( '<a href=' . '"/testezp/web/index.php/ezdemo_site_admin/state/groups"' . '>' );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
...
$setArray = $oldSetArray_4eb65d7be99018faf77398beceddf860;
$tpl->Level--;
?>
