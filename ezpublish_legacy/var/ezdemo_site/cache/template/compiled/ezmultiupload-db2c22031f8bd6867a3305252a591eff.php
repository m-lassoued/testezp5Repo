...
$oldSetArray_8093154b7f9f05fef8fef790fe0389fd = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ' title="Multiupload"><img class="ezwt-input-image" src="/testezp/web/extension/ezmultiupload/design/standard/images/ezwt-icon-upload.png" alt="Multiupload" /></a>
  ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_8093154b7f9f05fef8fef790fe0389fd;
$tpl->Level--;
?>
