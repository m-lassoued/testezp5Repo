...
$oldSetArray_45a7476bef47b80ba260bdc1afedb314 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
                    <img src="/testezp/web/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="Edit" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
{
$text .= '                <img src="/testezp/web/design/standard/images/edit-disabled.gif" alt="Edit" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_45a7476bef47b80ba260bdc1afedb314;
$tpl->Level--;
?>
