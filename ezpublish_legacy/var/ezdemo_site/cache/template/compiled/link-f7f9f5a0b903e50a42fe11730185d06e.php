...
$oldSetArray_e08383d8d166fe8c1d9f041936ad78a1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/testezp/web/index.php/ezdemo_site_admin" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$text .= '" />
<link rel="Index" href="/testezp/web/index.php/ezdemo_site_admin" />
<link rel="Top"  href="/testezp/web/index.php/ezdemo_site_admin" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/testezp/web/index.php/ezdemo_site_admin/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$text .= '" />
<link rel="Shortcut icon" href="/testezp/web/design/standard/images/favicon.ico" type="image/x-icon" />
<link rel="Copyright" href="/testezp/web/index.php/ezdemo_site_admin/ezinfo/copyright" />
<link rel="Author" href="/testezp/web/index.php/ezdemo_site_admin/ezinfo/about" />
<link rel="Alternate" type="application/rss+xml" title="RSS" href="/testezp/web/index.php/ezdemo_site_admin/rss/feed/my_feed" />
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_e08383d8d166fe8c1d9f041936ad78a1;
$tpl->Level--;
?>
