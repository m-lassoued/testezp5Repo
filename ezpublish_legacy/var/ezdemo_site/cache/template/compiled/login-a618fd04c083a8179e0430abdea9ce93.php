...
$oldSetArray_20a954e14ab7f5fb7826910f1329235f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="loginform" method="post" action="/testezp/web/index_dev.php/ezdemo_site_admin/user/login">
...
<div class="block">
    ...
    <div class="login-text-wrapper">
        or
        <br/>
        <a href="/testezp/web/index_dev.php/ezdemo_site_admin/user/register">Register new account</a>
    </div>
</div>
</div></div>
</div>
...
$setArray = $oldSetArray_20a954e14ab7f5fb7826910f1329235f;
$tpl->Level--;
?>
