...
$oldSetArray_18aa3b169e6ea56ccc5f90ad69184a8d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="ordering" method="post" action="/testezp/web/index.php/ezdemo_site_admin/content/action">
...
$setArray = $oldSetArray_18aa3b169e6ea56ccc5f90ad69184a8d;
$tpl->Level--;
?>
