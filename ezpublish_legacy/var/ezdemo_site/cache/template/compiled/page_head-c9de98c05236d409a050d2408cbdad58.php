...
$oldSetArray_7c63295333f721235943a9dc71ac0517 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '  ';
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'module_result', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['module_result'] : null;
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_402 = compiledFetchAttribute( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401, 'title_path' );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_402;
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401->templateValue();
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401->templateValue();
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 = isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 );unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_401 );
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40->templateValue();
...
elseif ( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_40 )
{
$text .= '    ';
unset( $var );
unset( $var );
...
{
$text .= '    ';
$oldRestoreIncludeArray_4bd415c1f1838e59ee3272131c85f2bb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/canonical_link-814423e98296a3f589544eeba5bd7b35.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/canonical_link-814423e98296a3f589544eeba5bd7b35.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_4bd415c1f1838e59ee3272131c85f2bb;
...
{
$text .= '    ';
$oldRestoreIncludeArray_ee278c2c6c2a3084f6d4a1b546d8a3a6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/link-e1898855d5557568f12778620aaecac1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/link-e1898855d5557568f12778620aaecac1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ee278c2c6c2a3084f6d4a1b546d8a3a6;
...
$setArray = $oldSetArray_7c63295333f721235943a9dc71ac0517;
$tpl->Level--;
?>
