...
$oldSetArray_6dc513c1f42ce4ef7eb6c831461ae2bd = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<link rel="stylesheet" type="text/css" href="/testezp/web/" />';
}
unset( $if_cond );
// if ends
...
$text .= '<link rel="stylesheet" type="text/css" href="/testezp/web/extension/ezdemo/design/ezdemo/stylesheets/print.css" media="print" />
';

$setArray = $oldSetArray_6dc513c1f42ce4ef7eb6c831461ae2bd;
$tpl->Level--;
?>
