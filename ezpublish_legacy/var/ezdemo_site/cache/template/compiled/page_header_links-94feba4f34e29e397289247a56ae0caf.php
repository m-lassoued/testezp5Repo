...
$oldSetArray_cb28262286202d3ca181096db725cd28 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <li id="shoppingbasket"><a href="/testezp/web/index_dev.php/shop/basket" title="Shopping basket">Shopping basket</a></li>
   ';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <li id="myprofile"><a href="/testezp/web/index_dev.php/user/edit" title="My profile">My profile</a></li>
    <li id="logout"><a href="/testezp/web/index_dev.php/user/logout" title="Logout">Logout ( ';
unset( $var );
unset( $var1 );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '    <li id="registeruser"><a href="/testezp/web/index_dev.php/user/register" title="Register">Register</a></li>
    ';
}
unset( $if_cond );
// if ends
...
$text .= '    <li id="login" class="transition-showed">
        ...
        <form class="login-form span3" action="/testezp/web/index_dev.php/user/login" method="post">
            <fieldset>
                <label>
                ...
                <div class="clearfix">
                    <a href="/testezp/web/index_dev.php/user/forgotpassword" class="forgot-password">Forgot your password?</a>
...
$setArray = $oldSetArray_cb28262286202d3ca181096db725cd28;
$tpl->Level--;
?>
