...
$oldSetArray_61adbe8994b2c843d2b825764c4a4445 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<form class="span4 form-search" method="get" action="/testezp/web/index_dev.php/content/search" id="site-wide-search">
...
$setArray = $oldSetArray_61adbe8994b2c843d2b825764c4a4445;
$tpl->Level--;
?>
