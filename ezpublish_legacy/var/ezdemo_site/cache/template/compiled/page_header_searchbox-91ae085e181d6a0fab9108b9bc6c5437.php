...
$oldSetArray_e314c3379233284a337bb2f52f462b8b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<form class="span4 form-search" method="get" action="/testezp/web/index.php/eng/content/search" id="site-wide-search">
...
$setArray = $oldSetArray_e314c3379233284a337bb2f52f462b8b;
$tpl->Level--;
?>
