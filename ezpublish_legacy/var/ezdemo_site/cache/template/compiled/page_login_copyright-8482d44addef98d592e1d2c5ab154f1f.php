...
$oldSetArray_e1fdc6760a904e22e57412895b98794a = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var2 = array( '%edition' => $var3, '%about_link' => "\"/testezp/web/index_dev.php/ezdemo_site_admin/ezinfo/about\"" );unset( $var3 );
...
$setArray = $oldSetArray_e1fdc6760a904e22e57412895b98794a;
$tpl->Level--;
?>
