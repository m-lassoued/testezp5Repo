...
$oldSetArray_c23eea2026075b57f6a7f8b58650a5f2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form action="/testezp/web/index.php/ezdemo_site_admin/content/search" method="get">
    ';
// if begins
unset( $if_cond );
unset( $if_cond );
...
{
$text .= '            <p class="advanced hide"><a href="/testezp/web/index.php/ezdemo_site_admin/content/advancedsearch" title="Advanced search.">Advanced</a></p>
        ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_c23eea2026075b57f6a7f8b58650a5f2;
$tpl->Level--;
?>
