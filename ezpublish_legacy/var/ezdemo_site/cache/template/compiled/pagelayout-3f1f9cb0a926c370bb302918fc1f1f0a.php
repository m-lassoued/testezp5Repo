...
$oldSetArray_0835fb312a9fe2586e244d2dd9b51cf7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$textStack[] = $text;
$text = '';
$oldRestoreIncludeArray_9c93252e289611a402097a9f899a633a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head-fbf0d5f390a89711512375ef680bb87d.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head-fbf0d5f390a89711512375ef680bb87d.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_9c93252e289611a402097a9f899a633a;

$oldRestoreIncludeArray_62a8ae7e3a1854716658a395c72dc470 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style-9eae69b5fb97a5409c5d9e2267936f74.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style-9eae69b5fb97a5409c5d9e2267936f74.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_62a8ae7e3a1854716658a395c72dc470;

$oldRestoreIncludeArray_452f6b0edea7642633beb98d2c5f5b8a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_script-b54841a4b3076f8b9208b23f76e13c23.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_script-b54841a4b3076f8b9208b23f76e13c23.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_452f6b0edea7642633beb98d2c5f5b8a;
...
';
$oldRestoreIncludeArray_68ccfd7ae4fbade231dba39d87dd1b92 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_header-0664b75c4120ecbd25d9f466b5feb635.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_header-0664b75c4120ecbd25d9f466b5feb635.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_68ccfd7ae4fbade231dba39d87dd1b92;
...
$text .= '
';
$oldRestoreIncludeArray_24fc3155cfc577b6eafc093798505c83 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenu-c7f31199433a8968eb4f442fe42a2c13.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenu-c7f31199433a8968eb4f442fe42a2c13.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_24fc3155cfc577b6eafc093798505c83;
...
if ( $if_cond )
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Show / Hide rightmenu" href="/testezp/web/index.php/ezdemo_site_admin/user/preferences/set/admin_right_menu_show/1"></a>
    <div id="rightmenu-design"></div>';
}
else
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Hide / Show rightmenu" href="/testezp/web/index.php/ezdemo_site_admin/user/preferences/set/admin_right_menu_show/0"></a>
    <div id="rightmenu-design">
        ';
$oldRestoreIncludeArray_b507b5153140943532f2ce525764dea6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_current_user-5b4a34360d65913bce21ad81f1b61a33.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_current_user-5b4a34360d65913bce21ad81f1b61a33.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_b507b5153140943532f2ce525764dea6;

$oldRestoreIncludeArray_0dbaa65fdc803c7ad1a798cbe870fa85 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_preferences-2345d05a8e7e66fbf8a950b379408b12.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_preferences-2345d05a8e7e66fbf8a950b379408b12.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0dbaa65fdc803c7ad1a798cbe870fa85;

$oldRestoreIncludeArray_63800ccafdde2ce97cf73b907f598e2d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-38c235de55c10a92dee58508f2d54c73.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-38c235de55c10a92dee58508f2d54c73.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_63800ccafdde2ce97cf73b907f598e2d;

$text .= '        ';
$oldRestoreIncludeArray_207d1d041f26fba5713013c5476d8922 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-6c0e1d0dc43d3bc6fe83fcf96837d51e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-6c0e1d0dc43d3bc6fe83fcf96837d51e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_207d1d041f26fba5713013c5476d8922;

$oldRestoreIncludeArray_865399e48e04e40674458fa7cc4b0763 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-651340573076a1e4c59823bfd4e7675c.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-651340573076a1e4c59823bfd4e7675c.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_865399e48e04e40674458fa7cc4b0763;
...
{
$text .= '    ';
$oldRestoreIncludeArray_7e59d290e91e9046a3bc30fecf6c953c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_leftmenu-5f206c310c66234f6594348381518bac.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_leftmenu-5f206c310c66234f6594348381518bac.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_7e59d290e91e9046a3bc30fecf6c953c;
...
{
$text .= '    ';
$oldRestoreIncludeArray_36b973c5f9c216391aeca916b4b9e16f = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_mainarea-609f0a84337e835ac09932f3c62d2bc7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_mainarea-609f0a84337e835ac09932f3c62d2bc7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_36b973c5f9c216391aeca916b4b9e16f;
...
$text .= '    <div id="maincontent">
    ...
    <div id="path">
        <div id="path-design">
            ';
$oldRestoreIncludeArray_32148e209530c1b570b52936aefbc559 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_toppath-07ff4d0f99c05e02939bc396ecc1ec73.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_toppath-07ff4d0f99c05e02939bc396ecc1ec73.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_32148e209530c1b570b52936aefbc559;
...
$text .= '        </div>
    ...
    <!-- Maincontent START -->
    ';
$oldRestoreIncludeArray_0cdfd186c84fed5361b527c4ad753a68 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_0cdfd186c84fed5361b527c4ad753a68;
...
<div id="footer-design">
    ';
$oldRestoreIncludeArray_4561eeac7f957b63aedb1d34dc9abfba = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_copyright-dd3b0f53b44c3eb4f83ac3792f44434b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_copyright-dd3b0f53b44c3eb4f83ac3792f44434b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_4561eeac7f957b63aedb1d34dc9abfba;
...
';
$oldRestoreIncludeArray_98259c975830d3f6f378ebb431f05a43 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/popup_menu-c6e8e596319286eaacffc703c0a4e85a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/popup_menu-c6e8e596319286eaacffc703c0a4e85a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_98259c975830d3f6f378ebb431f05a43;
...
$setArray = $oldSetArray_0835fb312a9fe2586e244d2dd9b51cf7;
$tpl->Level--;
?>
