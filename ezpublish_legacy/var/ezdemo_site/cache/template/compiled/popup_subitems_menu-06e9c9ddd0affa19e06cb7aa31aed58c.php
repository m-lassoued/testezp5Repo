...
$oldSetArray_bf340eaf836b514814a5bdc50643c8c8 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-view\'] = { \'url\': "/testezp/web/index.php/ezdemo_site_admin/content/view/full/%nodeID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-preview\'] = { \'url\': "/testezp/web/index.php/ezdemo_site_admin/content/versionview/%objectID%/%version%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-edit\'] = { \'url\': "/testezp/web/index.php/ezdemo_site_admin/content/edit/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy\'] = { \'url\': "/testezp/web/index.php/ezdemo_site_admin/content/copy/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy-subtree\'] = { \'url\': "/testezp/web/index.php/ezdemo_site_admin/content/copysubtree/%nodeID%" };
...
$setArray = $oldSetArray_bf340eaf836b514814a5bdc50643c8c8;
$tpl->Level--;
?>
