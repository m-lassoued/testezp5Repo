...
$oldSetArray_ab037b2e4f4823daff49190a17d28489 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
// foreach ends
$text .= '        </ul>
        <form method="post" action="/testezp/web/index_dev.php/eng/content/action">
            <fieldset>
...
$setArray = $oldSetArray_ab037b2e4f4823daff49190a17d28489;
$tpl->Level--;
?>
