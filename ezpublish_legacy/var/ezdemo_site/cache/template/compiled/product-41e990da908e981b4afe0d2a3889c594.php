...
$oldSetArray_2b5bfb3c0401be7fd75fffefa37ddc0e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
// foreach ends
$text .= '        </ul>
        <form method="post" action="/testezp/web/index.php/content/action">
            <fieldset>
...
$setArray = $oldSetArray_2b5bfb3c0401be7fd75fffefa37ddc0e;
$tpl->Level--;
?>
