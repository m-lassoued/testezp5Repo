...
$oldSetArray_62c1681ad2daa9e90e8af6452b0c3758 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/testezp/web/index.php/ezdemo_site_admin/content/translation">
...
<tr>
    <th class="tight"><img src="/testezp/web/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Language</th>
    <th>Locale</th>
...
$text .= '><img src="/testezp/web/extension/ezdemo/design/ezdemo/images/edit.gif" width="16" height="16" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_62c1681ad2daa9e90e8af6452b0c3758;
$tpl->Level--;
?>
