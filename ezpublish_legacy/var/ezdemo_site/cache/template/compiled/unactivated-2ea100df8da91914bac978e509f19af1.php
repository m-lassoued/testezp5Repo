...
$oldSetArray_b74c1c458e699a909e4454a8746058ec = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
// foreach begins
$skipDelimiter = true;
if ( !isset( $fe_variable_stack_dd75f0f0fb74691d822380aa66742e38_1 ) ) $fe_variable_stack_dd75f0f0fb74691d822380aa66742e38_1 = array();
...
$fe_array_keys_dd75f0f0fb74691d822380aa66742e38_1 = is_array( $fe_array_dd75f0f0fb74691d822380aa66742e38_1 ) ? array_keys( $fe_array_dd75f0f0fb74691d822380aa66742e38_1 ) : array();
...
// foreach begins
$skipDelimiter = true;
if ( !isset( $fe_variable_stack_dd75f0f0fb74691d822380aa66742e38_2 ) ) $fe_variable_stack_dd75f0f0fb74691d822380aa66742e38_2 = array();
...
$fe_array_keys_dd75f0f0fb74691d822380aa66742e38_2 = is_array( $fe_array_dd75f0f0fb74691d822380aa66742e38_2 ) ? array_keys( $fe_array_dd75f0f0fb74691d822380aa66742e38_2 ) : array();
...
$text .= '    <table class="list" cellspacing="0">
    <tr>
        <th class="tight"><img src="/testezp/web/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Toggle selection" onclick="ezjs_toggleCheckboxes( document.activations, \'DeleteIDArray[]\' ); return false;"/></th>
        <th';
unset( $var );
unset( $var1 );
unset( $var2 );
...
if ( !isset( $fe_variable_stack_dd75f0f0fb74691d822380aa66742e38_3 ) ) $fe_variable_stack_dd75f0f0fb74691d822380aa66742e38_3 = array();
...
$fe_array_keys_dd75f0f0fb74691d822380aa66742e38_3 = is_array( $fe_array_dd75f0f0fb74691d822380aa66742e38_3 ) ? array_keys( $fe_array_dd75f0f0fb74691d822380aa66742e38_3 ) : array();
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_10f0e39b9ec439d8ebd2866767c79738 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_10f0e39b9ec439d8ebd2866767c79738;
...
$setArray = $oldSetArray_b74c1c458e699a909e4454a8746058ec;
$tpl->Level--;
?>
