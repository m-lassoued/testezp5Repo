...
$oldSetArray_11a9dac8f11d20ae790dbfcfe3489351 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<script>
    _V_.options.flash.swf = "/testezp/web/extension/ezdemo/design/ezdemo/flash/video-js.swf"
</script>
...
$setArray = $oldSetArray_11a9dac8f11d20ae790dbfcfe3489351;
$tpl->Level--;
?>
