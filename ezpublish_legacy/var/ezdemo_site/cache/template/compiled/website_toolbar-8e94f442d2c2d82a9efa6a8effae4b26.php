...
$oldSetArray_4dcebf2e6598b47107d226a8c11377e5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
';
$oldRestoreIncludeArray_8bc36aee57050588d7cac9bc45c9718c = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/logo-f398b38f94f67426b9bdf9b73385ee29.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/logo-f398b38f94f67426b9bdf9b73385ee29.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_8bc36aee57050588d7cac9bc45c9718c;
...
$text .= '  <input type="hidden" name="ContentLanguageCode" value="eng-GB" />
  <input class="ezwt-input-image" type="image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-create.png" name="NewButton" title="Create here" />
</div>';
}
unset( $if_cond );
// if ends
...
$text .= '    <input type="hidden" name="ContentObjectLanguageCode" value="eng-GB" />
    <input class="ezwt-input-image" type="image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-edit.png" name="EditButton" title="Edit';
unset( $var );
unset( $var );
...
if ( $if_cond )
{
$text .= '    <input class="ezwt-input-image" type="image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-move.png" name="MoveNodeButton" title="Move';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_hint', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_hint'] : null;
if (! isset( $var ) ) $var = NULL;
...
if ( $if_cond )
{
$text .= '    <input class="ezwt-input-image" type="image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-remove.png" name="ActionRemove" title="Remove';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node_hint', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node_hint'] : null;
if (! isset( $var ) ) $var = NULL;
...
if ( $if_cond )
{
$text .= '        <input class="ezwt-input-image" type="image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-locations.png" name="AddAssignmentButton" title="Add locations" />
    ';
}
else
{
$text .= '        <input class="ezwt-input-image disabled" type="image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-locations-disabled.png" name="AddAssignmentButton" title="Add locations" disabled="disabled" />
    ';
}
unset( $if_cond );
// if ends
...
$text .= ' title="Sorting"><img src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-sort.png" alt="Sorting" /></a>
...
unset( $var );
$var = array (
  0 => 'http://localhost/testezp/web/index.php/ezdemo_site_admin/',
  1 => '',
);
...
$text .= '" target="_blank" title="Go to admin interface."><img src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-admin.png" alt="Go to admin interface." /></a>';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '<form method="post" action="/testezp/web/index.php/eng/ezodf/import" class="right">
...
$text .= '" />
  <input type="image" class="ezwt-input-image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-replace.png" name="ReplaceAction" title="Replace" />
</form>';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '<form method="post" action="/testezp/web/index.php/eng/ezodf/export" class="right">
  <input type="hidden" name="NodeID" value="';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'current_node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['current_node'] : null;
...
$text .= '" />
  <input type="image" class="ezwt-input-image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-export.png" name="ExportAction" title="Export" />
</form>';
}
unset( $if_cond );
// if ends
...
$text .= '" />
  <input type="image" class="ezwt-input-image" src="/testezp/web/extension/ezwt/design/standard/images/websitetoolbar/ezwt-icon-import.png" name="ImportAction" title="Import" />
</form>';
}
unset( $if_cond );
// if ends
...
$oldRestoreIncludeArray_ba180eb9bce35724a53208ed6935f2bf = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/help-a1e06eeef1dcb23e7bccb58f0293547d.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/help-a1e06eeef1dcb23e7bccb58f0293547d.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ba180eb9bce35724a53208ed6935f2bf;
...
';
$oldRestoreIncludeArray_46d05c2792197e6bcdf98ab01602cbd0 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/floating_toolbar-3feb08baf8cfdcd3cf4d97e59fa712e3.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/floating_toolbar-3feb08baf8cfdcd3cf4d97e59fa712e3.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_46d05c2792197e6bcdf98ab01602cbd0;
...
$setArray = $oldSetArray_4dcebf2e6598b47107d226a8c11377e5;
$tpl->Level--;
?>
