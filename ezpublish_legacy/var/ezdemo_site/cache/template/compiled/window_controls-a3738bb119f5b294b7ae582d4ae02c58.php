...
$oldSetArray_96a53f174c2b8b044226dc3100dda25a = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <div class="button-left"><a id="maincontent-show" class="show-hide-tabs" href="/testezp/web/index.php/ezdemo_site_admin/user/preferences/set/admin_navigation_content/1" title="Enable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
else
{
$text .= '    <div class="button-left"><a id="maincontent-hide" class="show-hide-tabs" href="/testezp/web/index.php/ezdemo_site_admin/user/preferences/set/admin_navigation_content/0" title="Disable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
unset( $if_cond );
// if ends
...
$text .= '    </li>
';
$oldRestoreIncludeArray_bf7e8d3894df9d2e0331ff208056eb83 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-3db0605f9e4286036fd9b44a5a78b6f4.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-3db0605f9e4286036fd9b44a5a78b6f4.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_bf7e8d3894df9d2e0331ff208056eb83;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_013bcbdbf8a7aeab579bb606c201995b = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/windows-d888b0a60d7500127bd57af963d71717.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/windows-d888b0a60d7500127bd57af963d71717.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_013bcbdbf8a7aeab579bb606c201995b;
...
$setArray = $oldSetArray_96a53f174c2b8b044226dc3100dda25a;
$tpl->Level--;
?>
