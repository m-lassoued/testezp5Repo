...
// Filename:  extension/ezdemo/design/ezdemo/override/templates/full/article.tpl
// Timestamp: 1389968166 (Fri Jan 17 15:16:06 CET 2014)
$oldSetArray_c875456d707ebd591a8344d2f49c28fb = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$tpl->processFunction( 'attribute_view_gui', $textElements,
  ...
  2 => 'extension/ezdemo/design/ezdemo/override/templates/full/article.tpl',
),
...
$text .= '            </div>
            ...
            <div class="attribute-socialize">
                ';
$oldRestoreIncludeArray_bd07fab71d971680f6e3d27757e7d2e2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_bd07fab71d971680f6e3d27757e7d2e2;
...
$text .= ' title="Tip a friend">Tip a friend</a></p>
            </div>
        ';
}
unset( $if_cond );
...
$text .= '
                    ';
$oldRestoreIncludeArray_4442a2ec4ad062b38634ca89cdc5aefc = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/related_content-5a6eb2c2a25defd6517065fa242352e4.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'extension/ezdemo/design/ezdemo/templates/parts/related_content.tpl' );
include( '' . 'var/ezdemo_site/cache/template/compiled/related_content-5a6eb2c2a25defd6517065fa242352e4.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'extension/ezdemo/design/ezdemo/templates/parts/related_content.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_4442a2ec4ad062b38634ca89cdc5aefc;
...
$setArray = $oldSetArray_c875456d707ebd591a8344d2f49c28fb;
$tpl->Level--;
?>
