...
// Filename:  extension/ezdemo/design/ezdemo/templates/content/datatype/view/ezprice.tpl
// Timestamp: 1389968167 (Fri Jan 17 15:16:07 CET 2014)
$oldSetArray_e6ab0b8dd6311c94f248ed4397860df4 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<span class="old-price">Price: ';
unset( $var );
...
$text .= '</span> <br />
<span class="new-price">Your price: ';
unset( $var );
// l10nTransformation begin
$locale = eZLocale::instance();
// l10nTransformation: static
...
$text .= '</span><br />
<span class="discount-percent">You save: ';
unset( $var );
// l10nTransformation begin
$locale = eZLocale::instance();
// l10nTransformation: static
...
$setArray = $oldSetArray_e6ab0b8dd6311c94f248ed4397860df4;
$tpl->Level--;
?>
