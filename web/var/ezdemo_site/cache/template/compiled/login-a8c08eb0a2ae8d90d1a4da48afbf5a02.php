...
$oldSetArray_19504b1420be73c9d54be298044c1a9b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="loginform" method="post" action="/testezp/web/index.php/ezdemo_site_admin/user/login">
...
<div class="block">
    ...
    <div class="login-text-wrapper">
        or
        <br/>
        <a href="/testezp/web/index.php/ezdemo_site_admin/user/register">Register new account</a>
    </div>
</div>
</div></div>
</div>
...
$setArray = $oldSetArray_19504b1420be73c9d54be298044c1a9b;
$tpl->Level--;
?>
